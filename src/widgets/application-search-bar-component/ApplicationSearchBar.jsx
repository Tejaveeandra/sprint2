...
const ApplicationSearchBar = ({ placeholderText, customClass, onClick, onChange, value, onSearchIconClick }) => {
  ...
  return (
    <div className={`${styles.search_bar} ${customClass}`} onClick={handleSearchBarClick}>
      <svg 
